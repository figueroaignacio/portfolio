...
export function ExperienceCard({ company, datetime, responsibilities, role, description, techStack }: ExperienceCardProps) {
  ...
  return (
    <div className="bg-card rounded-lg p-8 my-6 transition-all duration-300 border-[1px] border-border">
      ...
      <div className="mb-6">
        <h5 className="font-semibold text-sm mb-3">{t("components.experienceCard.responsibilities.label")}</h5>
      ...
      <div>
        <h5 className="font-semibold text-sm mb-3">{t("components.experienceCard.techStack.label")}</h5>
